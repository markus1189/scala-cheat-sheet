...
\end{minted}
  ...
  \TODO{Imports okay? Needed for line length}
\begin{minted}{scala}
...
\end{minted}
  \begin{mdframed}
    Don't blindly import the suggested \texttt{ExecutionContext}.  It
    is optimized for CPU-bound tasks and using it for blocking tasks

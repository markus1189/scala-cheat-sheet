...
\end{minted}
  ...
  \begin{center}
    \begin{tikzpicture}[auto,grow=right]
      \node[sup](animal){A};
      \node[sup, xshift=03mm, right of=animal         ](cage-animal-inv){F[A]};
      \node[sup, xshift=10mm, right of=cage-animal-inv](cage-animal-cov){F[+A]};
      \node[sup, xshift=10mm, right of=cage-animal-cov](cage-animal-con){F[-A]};

      \node[below of=animal](l1){};
      ...
      \node[sup, below of=l1](bird){B};
      \node[sup, xshift=03mm, right of=bird         ](cage-bird-inv){F[B]};
      \node[sup, xshift=10mm, right of=cage-bird-inv](cage-bird-cov){F[+B]};
      \node[sup, xshift=10mm, right of=cage-bird-cov](cage-bird-con){F[-B]};

      \path [line] (bird) -- (animal);
      % no relation for invariance
      \path [line, -] (cage-bird-cov) -- (l3) ;
      \path [line] (l3) -- (cage-animal-cov) ;
      \path [line, -] (cage-animal-con) -- (l4) ;
      \path [line] (l4) -- (cage-bird-con) ;
    \end{tikzpicture}
  \end{center}
...
\end{minted}
  ...
  \begin{mdframed}
    ...
    \par Prefer \mintinline{scala}|Vector| over
...
\end{minted}
  ...
  \begin{tabular}{l p{5cm}}
    ...
    \mintinline{scala}|foldRight| & like -Left, but for right associative ops \\
